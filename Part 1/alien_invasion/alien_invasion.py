...
from my_sounds import MySounds
...
class AlienInvasion:
	...
	def _fire_bullet(self):
		...
		if len(self.bullets) < self.settings.bullets_allowed and self.stats.game_active == True:
			new_bullet = Bullet(self)
			self.bullets.add(new_bullet)
			MySounds.play_sound('Sounds/bulletw.wav')
	...
	def _check_bullet_alien_collisions(self):
		...
		if collisions:
			...
			MySounds.play_sound('Sounds/explosion.wav')
	...
	def _ship_hit(self):
		...
		if self.stats.ships_left > 0:
			# Play the explotion sound.
			MySounds.play_sound('Sounds/Explosion2.wav')
